...
import com.roslibrary.ros.message.Clock;
import com.roslibrary.ros.message.Log;
import com.roslibrary.ros.rosapi.message.Empty;
import com.roslibrary.ros.rosapi.message.GetTime;
...
public class Example {
        ...
        try {
            ...
            Service<com.roslibrary.ros.rosapi.message.Service, Type> serviceTypeService =
                    new Service<com.roslibrary.ros.rosapi.message.Service, Type>("/rosapi/service_type",
                        com.roslibrary.ros.rosapi.message.Service.class, Type.class, client);
            serviceTypeService.verify();
            String type = serviceTypeService.callBlocking(new com.roslibrary.ros.rosapi.message.Service("/rosapi/service_response_details")).type;
            ...
            com.roslibrary.ros.Topic<Log> logTopic =
                    new com.roslibrary.ros.Topic<Log>("/rosout", Log.class, client);
            logTopic.verify();
    ...
    public static void testTopic(ROSBridgeClient client) {
        com.roslibrary.ros.Topic<Clock> clockTopic = new com.roslibrary.ros.Topic<Clock>("/clock", Clock.class, client);
