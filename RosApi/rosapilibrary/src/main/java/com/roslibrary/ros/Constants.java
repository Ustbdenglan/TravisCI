...
public class Constants {
    ...
    public static final String SUBSCRIBE_KEY_TOPIC = "{\"op\":\"subscribe\",\"topic\":\"/aimr_power/btn_state\"}";
    public static final String UNSUBSCRIBE_KEY_TOPIC = "{\"op\":\"unsubscribe\",\"topic\":\"/aimr_power/btn_state\"}";

    public static final String SUBSCRIBE_LED_TOPIC = "{\"op\":\"subscribe\",\"topic\":\"/aimr_power/led_state\"}";
    public static final String UNSUBSCRIBE_LED_TOPIC = "{\"op\":\"unsubscribe\",\"topic\":\"/aimr_power/led_state\"}";

    public static final String SUBSCRIBE_WHEEL_SPEED_TOPIC = "{\"op\":\"subscribe\",\"topic\":\"/joint_states_throttle\"}";
    public static final String UNSUBSCRIBE_WHEEL_SPEED_TOPIC = "{\"op\":\"unsubscribe\",\"topic\":\"/joint_states_throttle\"}";
