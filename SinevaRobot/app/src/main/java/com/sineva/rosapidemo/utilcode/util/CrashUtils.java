...
public final class CrashUtils {
    ...
    static {
        try {
            PackageInfo pi = SinevaUtils.getApp()
                    .getPackageManager()
                    .getPackageInfo(SinevaUtils.getApp().getPackageName(), 0);
            if (pi != null) {
    ...
    public static void init(final String crashDir, final OnCrashListener onCrashListener) {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                && SinevaUtils.getApp().getExternalCacheDir() != null)
            defaultDir = SinevaUtils.getApp().getExternalCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        else {
            defaultDir = SinevaUtils.getApp().getCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        }
