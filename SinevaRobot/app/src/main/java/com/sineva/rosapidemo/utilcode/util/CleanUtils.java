...
public final class CleanUtils {
    ...
    public static boolean cleanInternalCache() {
        return deleteFilesInDir(SinevaUtils.getApp().getCacheDir());
    }
    ...
    public static boolean cleanInternalFiles() {
        return deleteFilesInDir(SinevaUtils.getApp().getFilesDir());
    }
    ...
    public static boolean cleanInternalDbs() {
        return deleteFilesInDir(new File(SinevaUtils.getApp().getFilesDir().getParent(), "databases"));
    }
    ...
    public static boolean cleanInternalDbByName(final String dbName) {
        return SinevaUtils.getApp().deleteDatabase(dbName);
    }
    ...
    public static boolean cleanInternalSp() {
        return deleteFilesInDir(new File(SinevaUtils.getApp().getFilesDir().getParent(), "shared_prefs"));
    }
    ...
    public static boolean cleanExternalCache() {
        return Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                && deleteFilesInDir(SinevaUtils.getApp().getExternalCacheDir());
    }
