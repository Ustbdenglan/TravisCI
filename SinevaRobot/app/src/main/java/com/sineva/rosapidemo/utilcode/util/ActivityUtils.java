...
public final class ActivityUtils {
    ...
    public static boolean isActivityExists(@NonNull final String packageName,
        ...
        return !(SinevaUtils.getApp().getPackageManager().resolveActivity(intent, 0) == null ||
                intent.resolveActivity(SinevaUtils.getApp().getPackageManager()) == null ||
                SinevaUtils.getApp().getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
    ...
    public static List<Activity> getActivityList() {
        return SinevaUtils.sActivityList;
    }
    ...
    public static String getLauncherActivity() {
        return getLauncherActivity(SinevaUtils.getApp().getPackageName());
    }
    ...
    public static Activity getTopActivity() {
        if (SinevaUtils.sTopActivityWeakRef != null) {
            Activity activity = SinevaUtils.sTopActivityWeakRef.get();
            if (activity != null) {
                return activity;
            }
        }
        List<Activity> activities = SinevaUtils.sActivityList;
    ...
    public static Drawable getActivityIcon(final Class<?> clz) {
        return getActivityIcon(new ComponentName(SinevaUtils.getApp(), clz));
    }
    ...
    public static Drawable getActivityLogo(final Class<?> clz) {
        return getActivityLogo(new ComponentName(SinevaUtils.getApp(), clz));
    }
    ...
    private static Context getActivityOrApp() {
        ...
        return topActivity == null ? SinevaUtils.getApp() : topActivity;
    }
