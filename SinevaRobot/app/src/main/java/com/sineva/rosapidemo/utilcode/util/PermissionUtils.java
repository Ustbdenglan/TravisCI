...
import com.sineva.rosapidemo.utilcode.constant.PermissionConstants;
...
public final class PermissionUtils {
    ...
    public static List<String> getPermissions() {
        return getPermissions(SinevaUtils.getApp().getPackageName());
    }
    ...
    private static boolean isGranted(final String permission) {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.M
                ...
                == ContextCompat.checkSelfPermission(SinevaUtils.getApp(), permission);
    }
    ...
    public static void openAppSettings() {
        ...
        intent.setData(Uri.parse("package:" + SinevaUtils.getApp().getPackageName()));
        SinevaUtils.getApp().startActivity(intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }
    ...
    private void startPermissionActivity() {
        ...
        PermissionActivity.start(SinevaUtils.getApp());
    }
