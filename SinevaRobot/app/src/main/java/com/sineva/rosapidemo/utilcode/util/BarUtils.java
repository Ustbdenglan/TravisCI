...
public final class BarUtils {
    ...
    public static int getStatusBarHeight() {
        Resources resources = SinevaUtils.getApp().getResources();
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = SinevaUtils.getApp().getSystemService("statusbar");
    ...
    public static int getNavBarHeight() {
        Resources res = SinevaUtils.getApp().getResources();
