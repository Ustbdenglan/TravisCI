...
public final class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        SinevaUtils.getApp().startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS)
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        ConnectivityManager manager =
                (ConnectivityManager) SinevaUtils.getApp().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) SinevaUtils.getApp().getSystemService(Context.WIFI_SERVICE);
