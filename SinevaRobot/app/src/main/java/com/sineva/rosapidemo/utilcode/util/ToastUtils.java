...
public final class ToastUtils {
    ...
    private static int yOffset    = (int) (64 * SinevaUtils.getApp().getResources().getDisplayMetrics().density + 0.5);
    ...
    private static void show(@StringRes final int resId, final int duration) {
        show(SinevaUtils.getApp().getResources().getText(resId).toString(), duration);
    }

    private static void show(@StringRes final int resId, final int duration, final Object... args) {
        show(String.format(SinevaUtils.getApp().getResources().getString(resId), args), duration);
    }
    ...
    private static void show(final CharSequence text, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                sToast = Toast.makeText(SinevaUtils.getApp(), text, duration);
    ...
    private static void show(final View view, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                sToast = new Toast(SinevaUtils.getApp());
                sToast.setView(view);
    ...
    private static View getView(@LayoutRes final int layoutId) {
        LayoutInflater inflate =
                (LayoutInflater) SinevaUtils.getApp().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
