...
public final class PhoneUtils {
    ...
    public static boolean isPhone() {
        TelephonyManager tm =
                (TelephonyManager) SinevaUtils.getApp().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static void dial(final String phoneNumber) {
        SinevaUtils.getApp().startActivity(IntentUtils.getDialIntent(phoneNumber, true));
    }
    ...
    public static void call(final String phoneNumber) {
        SinevaUtils.getApp().startActivity(IntentUtils.getCallIntent(phoneNumber, true));
    }
    ...
    public static void sendSms(final String phoneNumber, final String content) {
        SinevaUtils.getApp().startActivity(IntentUtils.getSendSmsIntent(phoneNumber, content, true));
    }
    ...
    public static void sendSmsSilent(final String phoneNumber, final String content) {
        ...
        PendingIntent sentIntent = PendingIntent.getBroadcast(SinevaUtils.getApp(), 0, new Intent(), 0);
    ...
    public static void getAllContactInfo() {
        ...
        // 1.获取内容解析者
        ContentResolver resolver = SinevaUtils.getApp().getContentResolver();
