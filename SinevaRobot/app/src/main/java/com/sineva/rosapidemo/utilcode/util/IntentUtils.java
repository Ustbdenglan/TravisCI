...
public final class IntentUtils {
    ...
    public static Intent getInstallAppIntent(final File file,
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            data = FileProvider.getUriForFile(SinevaUtils.getApp(), authority, file);
        }
    ...
    public static Intent getLaunchAppIntent(final String packageName, final boolean isNewTask) {
        Intent intent = SinevaUtils.getApp().getPackageManager().getLaunchIntentForPackage(packageName);
