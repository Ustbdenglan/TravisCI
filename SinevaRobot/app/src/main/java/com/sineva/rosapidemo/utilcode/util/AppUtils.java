package com.sineva.rosapidemo.utilcode.util;
...
public final class AppUtils {
    ...
    public static boolean isInstallApp(final String action, final String category) {
        ...
        PackageManager pm = SinevaUtils.getApp().getPackageManager();
    ...
    public static void installApp(final File file, final String authority) {
        ...
        SinevaUtils.getApp().startActivity(IntentUtils.getInstallAppIntent(file, authority, true));
    }
    ...
    public static void uninstallApp(final String packageName) {
        ...
        SinevaUtils.getApp().startActivity(IntentUtils.getUninstallAppIntent(packageName, true));
    }
    ...
    public static void launchApp(final String packageName) {
        if (isSpace(packageName)) return;
        SinevaUtils.getApp().startActivity(IntentUtils.getLaunchAppIntent(packageName, true));
    }
    ...
    public static void exitApp() {
        List<Activity> activityList = SinevaUtils.sActivityList;
    ...
    public static String getAppPackageName() {
        return SinevaUtils.getApp().getPackageName();
    }
    ...
    public static void getAppDetailsSettings() {
        getAppDetailsSettings(SinevaUtils.getApp().getPackageName());
    }
    ...
    public static void getAppDetailsSettings(final String packageName) {
        if (isSpace(packageName)) return;
        SinevaUtils.getApp().startActivity(IntentUtils.getAppDetailsSettingsIntent(packageName, true));
    }
    ...
    public static String getAppName() {
        return getAppName(SinevaUtils.getApp().getPackageName());
    }
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(SinevaUtils.getApp().getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(SinevaUtils.getApp().getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(SinevaUtils.getApp().getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(SinevaUtils.getApp().getPackageName());
    }
    ...
    public static boolean isSystemApp() {
        return isSystemApp(SinevaUtils.getApp().getPackageName());
    }
    ...
    public static boolean isAppDebug() {
        return isAppDebug(SinevaUtils.getApp().getPackageName());
    }
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(SinevaUtils.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureSHA1() {
        return getAppSignatureSHA1(SinevaUtils.getApp().getPackageName());
    }
    ...
    public static boolean isAppForeground() {
        ActivityManager manager =
                (ActivityManager) SinevaUtils.getApp().getSystemService(Context.ACTIVITY_SERVICE);
        List<ActivityManager.RunningAppProcessInfo> info = manager.getRunningAppProcesses();
        if (info == null || info.size() == 0) return false;
        for (ActivityManager.RunningAppProcessInfo aInfo : info) {
            if (aInfo.importance == ActivityManager.RunningAppProcessInfo.IMPORTANCE_FOREGROUND) {
                return aInfo.processName.equals(SinevaUtils.getApp().getPackageName());
            }
        }
        return false;
    }
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(SinevaUtils.getApp().getPackageName());
    }
